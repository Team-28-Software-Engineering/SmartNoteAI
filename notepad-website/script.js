...
function confirmDownload(os, url) {
    ...
    const sections = {
        ...
        download: `
            <div class="fade-in">
                ...
                <p><a href="#" onclick="toggleDownloadInfo('macos')"> <span id="macos-info" class="arrow">&#9660;</span></a></p>
        ...
        author: `
            <div class="fade-in">
                ...
                <p>Github: <a href="https://github.com/Team-28-Software-Engineering/SmartNoteAI" target="_blank">https://github.com/Team-28-Software-Engineering/SmartNoteAI</a></p>
            </div>
        `
    };
